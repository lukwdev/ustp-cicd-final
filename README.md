...
## 🔗 Live Demo
**[Play the Game Here](https://lukwdev.github.io/ustp-cicd-final/)**
...
```bash
git clone [https://github.com/lukwdev/ustp-cicd-final.git](https://github.com/lukwdev/ustp-cicd-final.git)
cd ustp-cicd-final
npm install
